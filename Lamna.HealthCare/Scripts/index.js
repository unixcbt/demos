$(function () {
    ...
    $('#patient-name').click(function () {
        window.location = "https://lamnahealthcare.azurewebsites.net/Home/Appointment?conferenceUri=adhoc";
    });

    $("#erick-loftus").click(function () {
        window.location = "https://lamnahealthcare.azurewebsites.net/Home/Appointment";
    });
